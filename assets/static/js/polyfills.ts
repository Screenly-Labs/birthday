...
// 2020), used by main.ts to fill the confetti field. Everything else the app
// needs (fetch, Intl.DateTimeFormat, URLSearchParams) already exists at the floor,
// so this stays a few lines rather than pulling in core-js.
//
